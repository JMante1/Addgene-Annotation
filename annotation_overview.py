...
df.to_csv(os.path.join(cwd, 'Analysis', 'subparts_overview_nosnap1.csv'))
df.to_excel(os.path.join(cwd, 'Analysis', 'subparts_overview_nosnap1.xlsx'))

df1 = pd.DataFrame.from_dict(all_an_dict, orient='index')
df1.to_excel(os.path.join(cwd, 'Analysis', 'annotations_set_nosnap1.xlsx'))